  ...
  return (
    ...
    <div className="flex ">
        <ul className="list-none sm:flex justify-center items-center">
            <li className="mx-2 hover:text-yellow-500 cursor-pointer"><a href="#Home">{props.home}</a></li>
            <li className="mx-2 hover:text-yellow-500 cursor-pointer"><a href="#AboutUs">{props.about}</a></li>
            <li className="mx-2 hover:text-yellow-500 cursor-pointer"><a href="#Contact">{props.contact}</a></li>
        </ul>
